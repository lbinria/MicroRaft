...
public class RequestVoteRequest extends RequestMessage implements TLASerializer {
    ...
    public RequestVoteRequest(String from, String to, long term, long lastLogTerm, long lastLogIndex,
            long senderClock) {
    ...
    public RequestVoteRequest(JsonObject jsonObject) {
        super(jsonObject.get("msource").getAsString(), jsonObject.get("mdest").getAsString(),
                MessageType.RequestVoteRequest, jsonObject.get("mterm").getAsLong(),
                jsonObject.get("mlastLogTerm").getAsLong(), jsonObject.get("mlastLogIndex").getAsLong(),
