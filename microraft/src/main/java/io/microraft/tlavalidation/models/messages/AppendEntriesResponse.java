...
public class AppendEntriesResponse extends Message implements TLASerializer {
    ...
    public AppendEntriesResponse(String from, String to, long term, boolean success, long matchIndex,
            long senderClock) {
    ...
    public AppendEntriesResponse(JsonObject jsonObject) {
        super(jsonObject.get("msource").getAsString(), jsonObject.get("mdest").getAsString(),
                MessageType.AppendEntriesResponse, jsonObject.get("mterm").getAsLong(),
